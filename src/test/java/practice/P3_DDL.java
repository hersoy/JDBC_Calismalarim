...
public class P3_DDL {
    /*
                 ...
                 B)   - execute() metodu her tur SQL ifadesiyle kullanibilen genel bir komuttur.
                      ...
                      - DDL islemleri false dondururken, DML islemlerinde true deger dondurur.(ResultSet olusturur)
    ...
    public static void main(String[] args) throws ClassNotFoundException, SQLException {
        ...
        //1.yontem : execute () methodu ile
         ...
         System.out.println("markalar tablosu olusturuldu "+s1);
/*
        //2.yontem : executeUpdate() methodu ile
        int s2 = st.executeUpdate(createQuery);
        System.out.println("markalar tablosu olusturuldu " + s2);

        // SORU: markalar tablosunu siliniz
        String dropTable="drop table markalar";
        ...
        System.out.println("markalar tablosunun ismi degistirildi");
        ...
        System.out.println("marka_isim colonunun ismi degistirildi");
*/
